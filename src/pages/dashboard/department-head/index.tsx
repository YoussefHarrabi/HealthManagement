...
import SupervisionDashboard from '../../../components/department-head/SupervisionDashboard';

type DepartmentHeadHomeProps = {
  user: {
    id: string;
    name: string;
    email: string;
...
export default function DepartmentHeadHome({ user, logout }: DepartmentHeadHomeProps) {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/dashboard/department-head', icon: ChartBarIcon, current: true },
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-gray-100">
      <Head>
        <title>Department Head Dashboard | Healthcare Management System</title>
      </Head>
