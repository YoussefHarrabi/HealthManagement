...
import DepartmentReports from '../../../components/department-head/DepartmentReports';

type DepartmentReportsPageProps = {
  user: {
    id: string;
    name: string;
    email: string;
...
export default function DepartmentReportsPage({ user, logout }: DepartmentReportsPageProps) {
  ...
  const navigation = [
    ...
    { name: 'Doctors List', href: '/dashboard/department-head/doctors', icon: UsersIcon, current: false },
    { name: 'Reports', href: '/dashboard/department-head/reports', icon: DocumentReportIcon, current: true },
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-gray-100">
      <Head>
        <title>Department Reports | Healthcare Management System</title>
      </Head>
