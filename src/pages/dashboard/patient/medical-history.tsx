...
export default function MedicalHistoryPage({ user, logout }: MedicalHistoryPageProps) {
  ...
  const navigation = [
    ...
    { name: 'Medical History', href: '/dashboard/patient/medical-history', icon: DocumentTextIcon, current: true },
    { name: 'Appointments', href: '/dashboard/patient/appointments', icon: ClockIcon, current: false },
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-gray-100">
      <Head>
        <title>Medical History | Healthcare Management System</title>
      </Head>
