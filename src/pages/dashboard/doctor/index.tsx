...
import DoctorDashboard from '../../../components/doctor/PatientList';
...
export default function DoctorHome({ user, logout }: DoctorHomeProps) {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/dashboard/doctor', icon: ChartBarIcon, current: true },
